...
for r in rand_num2:
      ...
      TM_ns = test_module(bounds=bounds, sut=lambda x0: sut(800,x0), optimizer=GradientAcquisitionOptimizer(bound),f_tree = node4,init_sample =44, with_ns=True,
                          optimize_restarts=2, exp_weight=2, normalizer=False)
      TM_ns.initialize()
      TM_ns.run_BO(66) 
